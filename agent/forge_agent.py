...
MAX_ATTEMPTS = 1 # number of attempts to generate the solution
_SOLVER_TIMEOUT = 60  # seconds

class ForgeAgent(Solver):
    """
    Solver subclass for the Forge backend.
    """
    def __init__(
        self,
...
"""
            ...
            self.__result_trace.solver_exit_code = exit_code
    ...
    async def __format_solution(self, solution: str) -> None:
        ...
        if format_prompt:
            ...
            # If no format prompt is provided, return the unformatted solution.
    ...
    async def util_communicate_to_sterling_client(self, solver_input_file: str) -> tuple[int, str, str]:
        ...
        try:
            ...
            try: 
                ...
                print("DEBUG: Sterling client finished with exit code", exit_code)
